...
\\\json
{
  "input_date": "2026-05-07",
  "prediction": 280.5,
  "message": "Berdasarkan data 2026-05-07, prediksi harga AAPL besok: \.50",
  "model": "AAPL-RF-Production@production"
}
\\\
...
\\\json
{
  ...
  "model_alias": "production",
  "timestamp": "2026-05-20T07:14:28.664802",
  "message": "Prediksi harga penutupan AAPL besok: \.50"
}
\\\
...
## ?? Horizontal Scaling � Menambah Replika API

Sistem menggunakan **Nginx sebagai load balancer** yang mendistribusikan request ke 3 replika pi-service secara otomatis.
...
Edit bagian \deploy.replicas\ pada service \pi-service\:
\\\yaml
api-service:
  deploy:
...
\\\ash
>>>>>>> 69a8684 (feat(LK-10): horizontal scaling, model registry, API endpoints, update README)
...
| Metrik | Nilai | Keterangan |
|--------|-------|------------|
| RMSE | 4.3644 | Error rata-rata �\.36 |
| MAE | 3.3308 | Absolut error rata-rata |
| R� | 0.8582 | Menjelaskan 85.82% variansi |
...
# 📊 Fitur Teknikal
=======
## ?? CI/CD Pipeline � Code as Trigger (LK-8)
\\\
git push origin main
?
